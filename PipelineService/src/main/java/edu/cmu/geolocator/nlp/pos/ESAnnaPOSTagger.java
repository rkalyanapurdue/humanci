...
public class ESAnnaPOSTagger implements POSTagger{
  ...
  public edu.cmu.geolocator.model.Sentence tag(edu.cmu.geolocator.model.Sentence sent){
...
//		System.out.println("Applying the part-of-speech tagger");
	...
	public static void main(String argv[]) {
		...
		ESAnnaPOSTagger postagger = new ESAnnaPOSTagger("/home/ec2-user/geo-locator/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.postagger.model");
		List<String> tags = postagger.tag(text);
		System.out.println(tags);
	}

  private static ESAnnaPOSTagger estagger;
  
  public static ESAnnaPOSTagger getInstance(){
    if (estagger==null)
      estagger =  new ESAnnaPOSTagger("/home/ec2-user/geo-locator/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.postagger.model");
    return estagger;
  }
