 ...
 * 
 */
package edu.cmu.geolocator.nlp.lemma;
 ...
 * 
 */
public class AnnaLemmatizer implements edu.cmu.geolocator.nlp.Lemmatizer {
  ...
  public static void main(String argv[]) {
    // String s =
    // "What a Sunday! Miss anything? We've got you covered in @Windows Week 2 Review (it's not too soon to talk playoffs) � http://bit.ly/18BpV3z ";
    ...
    AnnaLemmatizer en = new AnnaLemmatizer(
            "/home/ec2-user/geo-locator/en/CoNLL2009-ST-English-ALL.anna-3.3.lemmatizer.model");
    int i = 0;
  ...
  private static AnnaLemmatizer eslemma, enlemma;


  public static edu.cmu.geolocator.nlp.Lemmatizer getInstance(String string) throws Exception {
    if (string.equalsIgnoreCase("es")) {
      if (eslemma == null)
        eslemma = new AnnaLemmatizer("/home/ec2-user/geo-locator/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.lemmatizer.model");
      return eslemma;
    }
    if (string.equalsIgnoreCase("en")) {
      if (enlemma == null)
        enlemma = new AnnaLemmatizer("/home/ec2-user/geo-locator/en/CoNLL2009-ST-English-ALL.anna-3.3.lemmatizer.model");
      return enlemma;
    }
    throw new Exception("Language not supported by Lemmatizer!");
  }
}
