...
public class MTNERParser implements NERTagger {
  ...
  private static MTNERParser englishparser, spanishparser;

  public static MTNERParser getInstance(String lang) throws Exception {
    if (lang.equalsIgnoreCase("en")) {
      if (englishparser == null) {
        try {
          englishparser = new MTNERParser("/home/ec2-user/geo-locator/en/enNER-crf-final.model",
    ...
    if (lang.equalsIgnoreCase("es")) {
      if (spanishparser == null) {
        try {
          englishparser = new MTNERParser("/home/ec2-user/geo-locator/es/esNER-crf-final.model",
...
//          System.out.println(startpos + " " + endpos + " " + previous);
  ...
  public static void main(String argv[]) throws IOException {
    ...
    while (true) {
      ...
      List<LocEntityAnnotation> matches = ParserFactory.getEnNERParser().parse(t);
